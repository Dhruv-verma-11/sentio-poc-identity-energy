...
MATCH_THRESHOLD = 0.6   # 🔥 better realistic threshold
MAX_KEYFRAMES = 20
...
def detect_and_match(frame, known, threshold):
    global TOTAL_FACES_DETECTED, TOTAL_FACES_MATCHED, TOTAL_FACES_UNKNOWN
...
def generate_report(persons, path):
    ...
    <h2>Summary</h2>
    <p>Total Faces Detected: {TOTAL_FACES_DETECTED}</p>
    <p>Matched Faces: {TOTAL_FACES_MATCHED}</p>
    <p>Unknown Faces: {TOTAL_FACES_UNKNOWN}</p>
    """
...
if __name__ == "__main__":
    ...
    print("Matched Faces:", TOTAL_FACES_MATCHED)
    print("Unknown Faces:", TOTAL_FACES_UNKNOWN)
